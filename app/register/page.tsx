        ...
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <label className="flex items-start gap-2.5 text-sm text-zinc-500">
              ...
              <span>
                I agree to the{" "}
                <Link href="/terms" className="font-medium text-[#075E54] transition-colors hover:text-[#25D366]">Terms of Service</Link>
                {" "}and{" "}
                <Link href="/privacy" className="font-medium text-[#075E54] transition-colors hover:text-[#25D366]">Privacy Policy</Link>
              </span>
            </label>
