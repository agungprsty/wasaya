      ...
      <div className="mx-auto flex w-full max-w-6xl px-6 py-10 gap-8">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="mt-2 text-zinc-600">
            Complete documentation for the WAGateway REST API. All endpoints are accessible programmatically using your API keys.
          </p>
          ...
          <section id="introduction" className="mt-10 scroll-mt-24">
            ...
            <p className="mt-3 text-zinc-600 leading-relaxed">
              The WAGateway API allows you to send and manage WhatsApp messages programmatically. You can integrate
...
// Note: The key value is only shown once at creation.`} />
          ...
          <section id="webhooks" className="mt-10 scroll-mt-24">
            ...
            <p className="mt-3 text-zinc-600 leading-relaxed">
              ...
              to receive real-time event notifications from WAGateway.
            </p>
            ...
            <p className="mt-1 text-sm text-zinc-600">
              ...
              webhook requests are genuinely from WAGateway. Use this secret to validate HMAC signatures on each payload.
            </p>
